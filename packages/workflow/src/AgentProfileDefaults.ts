...
const definitions: Array<{ id: string; name: string; whereToUse: string; instructions: string; effort: EffortLevel; permissionProfileId: string; preferences: string[] }> = [
  { id: "planner", name: "Planner", whereToUse: "Break a broad or unclear request into concrete steps before any code is written.",
    instructions: "Plan the work. Do not edit files.", effort: "high", permissionProfileId: "read_only", preferences: ["claude", "codex", "opencode", "antigravity"] },
  { id: "coder", name: "Coder", whereToUse: "Write and change code — the default for ordinary implementation work.",
    instructions: "Implement the requested change and verify it.", effort: "medium", permissionProfileId: "auto_edit", preferences: ["codex", "claude", "opencode", "antigravity"] },
  { id: "architect", name: "Architect", whereToUse: "Large, risky, or cross-cutting changes needing careful reasoning.",
    instructions: "Reason carefully about architecture and make only approved changes.", effort: "high", permissionProfileId: "ask_before_changes", preferences: ["claude", "codex", "opencode", "antigravity"] },
  { id: "reviewer", name: "Reviewer", whereToUse: "Check finished work for bugs, regressions, security issues, and missing tests.",
    instructions: "Review the current changes. Report concrete findings and do not edit files.", effort: "high", permissionProfileId: "read_only", preferences: ["claude", "codex", "opencode", "antigravity"] },
  { id: "doc-writer", name: "Doc Writer", whereToUse: "Write or update README, PRD, changelog, or architecture notes.",
    instructions: "Write clear documentation that matches the implementation.", effort: "medium", permissionProfileId: "auto_edit", preferences: ["opencode", "claude", "codex", "antigravity"] },
];
